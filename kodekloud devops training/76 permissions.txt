...
open jenkins dashboard and install plugin
    -> Matrix Authorization Strategy

give certain access to the users in the jenkins master.
    -> From jenkins dashboard > Manage Jenkins > security > Authorization > project based matrix Authorization
        -> add user 
            -> rohan > admimistrator permission
            -> sam > admimistrator permission
            -> admin > admimistrator permission (compulsory)
    -> from home page > select and configure Package job > Enable project-based security > inheritance permission from parent ACL 
        -> add user 
            -> rohan > select permission as given
            -> sam > select permission as given
