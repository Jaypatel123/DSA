...
3) The EC2 instance is configured with a cron job that uploads a test file to a bucket datacenter-nat-6326 once internet is accessible.
...
Once complete, verify that the EC2 instance can reach the internet by confirming the presence of the test file in the S3 bucket datacenter-nat-6326. After completing all the configuration, please wait a few minutes for the test file to appear in the bucket, as it may take 2–3 minutes.
...
2) Create public subnet 
    - Select Appropriate IP range Eg: 10.1.2.0/24

3) Create Public route table 
    - add Internet gateway 0.0.0.0 -> Internet gatway
    - associate route table to public subnet

4) create Nat Gateway
    - Wait for 2-3 min until it's not ready

5) modify route table of private subnet
    - add Nat Gatway 0.0.0.0
