...
variable "priv_sub_name" {
    default = "datacenter-priv-subnet"
}
...
resource "aws_instance" "private_instance" {
    ...
    aws_security_group_ids = [aws_security_group.private_security_group.id]
    tags = {
        Name = instance_name
    }
}
